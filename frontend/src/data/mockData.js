...
export const mockVisitors = [
  {
    ...
    websiteUrl: 'https://brightshop.com',
    browser: 'Chrome',
    device: 'MacBook Air',
    page: '/product/eco-bottle',
    currentPage: '/product/eco-bottle',
    pageTrail: ['/home', '/collections/eco', '/product/eco-bottle'],
    status: 'Active',
    ...
    offlineForm: {
      ...
      email: 'jamie.cole@mail.com',
      company: 'BrightShop',
      message: 'Need help comparing subscription options.',
    },
    score: '88%',
  },
  {
    ...
    company: 'StudioLuxe',
    location: 'London, UK',
    websiteUrl: 'https://studioluxe.co.uk',
    browser: 'Safari',
    device: 'iPhone',
    page: '/support',
    currentPage: '/support',
    pageTrail: ['/pricing', '/support', '/support/billing'],
    status: 'Waiting',
    conversationStatus: 'Awaiting reply',
    duration: '12m ago',
    timeOnSite: '14m 11s',
    visitsCount: 3,
    returnsCount: 2,
  ...
  },
  {
    ...
    websiteUrl: 'https://marketflow.io',
    browser: 'Edge',
    device: 'Windows Laptop',
    page: '/checkout',
    currentPage: '/checkout',
    pageTrail: ['/landing', '/pricing', '/checkout'],
    status: 'Offline',
